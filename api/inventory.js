...
const safeEscape = (value) => validator.escape(value != null ? value : "");
...
app.post("/product", function (req, res) {
    ...
    let Product = {
        _id: parseInt(safeEscape(req.body.id)),
        barcode: parseInt(safeEscape(req.body.barcode)),
        expirationDate: safeEscape(req.body.expirationDate),
        price: safeEscape(req.body.price),
        category: safeEscape(req.body.category),
        quantity:
            safeEscape(req.body.quantity) == ""
                ? 0
                : safeEscape(req.body.quantity),
        name: safeEscape(req.body.name),
        stock: req.body.stock === "on" ? 0 : 1,
        minStock: safeEscape(req.body.minStock),
        img: image,
        purchase_discount: safeEscape(req.body.purchase_discount) == "" ? 0 : parseFloat(safeEscape(req.body.purchase_discount)),
        sale_discount: safeEscape(req.body.sale_discount) == "" ? 0 : parseFloat(safeEscape(req.body.sale_discount)),
    };

    if (safeEscape(req.body.id) === "") {
